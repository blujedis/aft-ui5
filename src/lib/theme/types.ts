...
export const FillColorSoft = {
  ...
  light: 'text-frame-100 dark:text-frame-500',
...
export const FillColorSoftHover = {
  ...
  light: 'hover:text-frame-200 dark:hover:text-frame-600',
...
export const StrokeColorSoft = {
  ...
  light: 'stroke-frame-100 dark:stroke-frame-500',
...
export const StrokeColorSoftHover = {
  ...
  light: 'hover:stroke-frame-200 dark:hover:stroke-frame-600',
